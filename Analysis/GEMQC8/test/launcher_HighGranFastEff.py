...
if __name__ == '__main__':
    ...
    outDirPath = os.path.abspath("launcher_HighGranFastEff.py").split('QC8Test')[0] + "Results_QC8_HighGranFastEff_run_"+str(args.run_number)
    ...
    mvToDirCommand = "mv HighGranFastEff_" + out_name + " " + outDirPath + "/HighGranFastEff_" + out_name
    ...
    # High Granularity Fast Efficiency computation & output
    rootMacroCommand = "root -l -q -b " + runPath + "macro_HighGranFastEff.c(" + str(args.run_number) + ",\"" + configTablesPath + "\")"
